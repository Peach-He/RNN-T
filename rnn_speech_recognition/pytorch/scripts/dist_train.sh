...
export I_MPI_PIN_PROCESSOR_EXCLUDE_LIST="16,17,34,35"
...
mpiexec.hydra -np 2 -ppn 2 -l -genv I_MPI_PIN_DOMAIN=socket -genv OMP_PROC_BIND=true \
              -genv KMP_BLOCKTIME=1 -genv KMP_AFFINITY=granularity=fine,compact,1,0 \
              -genv OMP_NUM_THREADS=32 \
